    ...
    return (
        <div>
            <div className="bg-[#3b7f9188] mt-12 shadow8 py-5  md:ml-0 lg:ml-[250px] rounded-3xl lg:w-[485px]">
                <h3 className="text-3xl font-semibold text-gray-600 md:ml-32 ml-16 lg:ml-44">Upload Material</h3>
                <div className=" md:w-1/3 mt-10 mb-10 md:pl-[68px] pl-14 lg:pl-[90px]">
                    <form onSubmit={handleAddJob}>
                        ...
                        <input className=" btn cursor-pointer ml-10 lg:ml-0 md:ml-0 mt-1 lg:w-[305px] md:w-[250px] py-2 px-4 border-2 rounded-md border-gray-300 bg-blue-500 text-white text-lg font-medium" type="submit" value="Upload Now" />
