...
const CreateNote = () => {
    ...
    return (
        <div className="lg:ml-32 md:ml-0 ml-0 ">
            <div>
                <ToastContainer />
                <div className="mt-4 bg-gray-200 shadow8 pt-5 pb-8 md:ml-0 rounded-3xl lg:w-[745px] md:w-[400px] lg:pl-[40px] md:pl-[40px] pl-[50px]">
                    <h3 className="text-3xl font-semibold lg:ml-48 text-gray-500">Create A Note Now</h3>
                        ...
                        >
                            <div>
                                ...
                                <div>
                                    ...
                                    <input className="btn hover:bg-orange-800 cursor-pointer ml-10 lg:ml-0 md:ml-0 mt-1 lg:w-[665px] md:w-[280px] py-2 px-4 border-2 rounded-md border-gray-300 bg-blue-500 text-white text-lg font-medium" type="submit" value="Save Note" />
                                </div>
                            </div>
                        </form>
                    </div>
